...
namespace SharedControls.Classes
{
    ...
    public class InputBox
    {
        ...
        /// <returns>InputBoxResult</returns>
        public static InputBoxResult Show(string Prompt, string Title, bool InputMasked)
        {
            InitializeComponent();
